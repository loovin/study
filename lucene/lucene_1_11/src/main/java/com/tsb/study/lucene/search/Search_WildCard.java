...
public class Search_WildCard {
	...
	public void searchByWildCard(String field, String value) {
		System.out.println("============== search by wild card:('" + field + "'='" + value + "') ===========");
	...
	public static void main(String[] args) {
		Search_WildCard indexUtil = new Search_WildCard();
		indexUtil.index();
		
		indexUtil.searchByWildCard("name", "j?");
		indexUtil.searchByWildCard("name", "j*");
		
		indexUtil.searchByWildCard("content", "w*t");
		indexUtil.searchByWildCard("content", "*m?");
	}
