...
public class Search_Prefix {
	...
	public void searchByPrefix(String field, String value) {
		System.out.println("============== search by prefix:('" + field + "'='" + value + "') ===========");
	...
	public static void main(String[] args) {
		Search_Prefix indexUtil = new Search_Prefix();
		indexUtil.index();
		
		indexUtil.searchByPrefix("content", "ping");
		indexUtil.searchByPrefix("name", "j");
	}
